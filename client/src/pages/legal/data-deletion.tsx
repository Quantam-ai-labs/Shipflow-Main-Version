...
const sections = [
  ...
  { id: "option-1", title: "Option 1: Disconnect Integrations" },
  { id: "option-2", title: "Option 2: Email Request" },
  { id: "option-3", title: "Option 3: Contact Form" },
  { id: "what-gets-deleted", title: "What Gets Deleted" },
  { id: "retention-exceptions", title: "Data Retention Exceptions" },
  { id: "facebook-data", title: "Facebook Data Specifically" },
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex gap-10">
            ...
            <div className="flex-1 min-w-0 rounded-2xl border border-white/10 bg-white/3 backdrop-blur-xl p-6 sm:p-8 space-y-8">
              ...
              <section id="option-1" className="space-y-3 scroll-mt-28">
              ...
              <section id="option-2" className="space-y-3 scroll-mt-28">
              ...
              <section id="option-3" className="space-y-3 scroll-mt-28">
              ...
              <section id="what-gets-deleted" className="space-y-3 scroll-mt-28">
              ...
              <section id="retention-exceptions" className="space-y-3 scroll-mt-28">
              ...
              <section id="facebook-data" className="space-y-3 scroll-mt-28">
