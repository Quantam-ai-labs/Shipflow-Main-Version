...
export const merchants = pgTable("merchants", {
  ...
  metaOauthAccessToken: text("meta_oauth_access_token"),
  metaOauthTokenExpiresAt: timestamp("meta_oauth_token_expires_at"),
  metaSelectedAdAccountId: varchar("meta_selected_ad_account_id", { length: 255 }),
  metaSelectedPageId: varchar("meta_selected_page_id", { length: 255 }),
  metaSelectedPageName: varchar("meta_selected_page_name", { length: 500 }),
  metaSelectedPixelId: varchar("meta_selected_pixel_id", { length: 255 }),
  metaSelectedIgAccountId: varchar("meta_selected_ig_account_id", { length: 255 }),
  metaSelectedIgAccountName: varchar("meta_selected_ig_account_name", { length: 500 }),
  ...
  robocallMaxAttempts: integer("robocall_max_attempts").default(3),
  robocallRetryGapMinutes: integer("robocall_retry_gap_minutes").default(45),
  waMaxAttempts: integer("wa_max_attempts").default(3),
  waAttempt2DelayHours: integer("wa_attempt2_delay_hours").default(4),
  waAttempt3DelayHours: integer("wa_attempt3_delay_hours").default(12),
...
export const orders = pgTable("orders", {
  ...
  attributedCampaignId: varchar("attributed_campaign_id", { length: 100 }),
  attributedAdId: varchar("attributed_ad_id", { length: 100 }),
...
// ============================================
// ROBOCALL LOGS (IVR call history)
// ============================================
